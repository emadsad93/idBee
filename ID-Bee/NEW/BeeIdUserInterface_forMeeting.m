                        ...
                        case 'Correct Cell Coloring'
                            ...
                            while(moreCells == 1 && counter <8)
                               ...
                               % hFig = figure;
                                ...
                                if (m == 0 || (counter == 0))
                                    cellAnswer = MFquestdlg ( [ 0.2 , 0], 'To color a selected cell, first click on a point inside the cell; then, click on a point on its boundary and drag through it until you have a closed loop. You can always repeat the last cell coloring step by clicking on "Redo". If you are happy with the current coloring of the cell, you may "Proceed to Labeling".', 'Bee-ID', ...
...
%                                 title('Manually Coloring Missing/Incomplete Cells','FontSize', 24);
                                ...
                                if (m == 0 || (j ==0))
                                    ...
                                    cellAnswer = MFquestdlg ( [ 0.19 , 0], 'To start coloring a selected cell, click on a point on its boundary and drag through it until you have a closed loop. You can always repeat the last cell coloring step by clicking on "Redo". If you are happy with the current coloring of the cell, you may "Proceed to Labeling".                                                           Repeat this procedue until you color all required cells.',...
                                        'Bee-ID', ...
                                        'Start/Continue Coloring','Redo' ,'Proceed to Labeling', 'Green');
                                end
%                                 if (m ==1 && (j ~= 0))
...
%                                 end
                        ...
                        case 'Proceed to Labeling'
                            ...
                            while(done ~= 1)
                                ...
                                set(h1,'alphadata',0.6)
                                if firstTime == 1
                                    answer = MFquestdlg ( [ 0.23 , 0.1], 'Instructions for Manually Labeling of Bee Wing Cells:                                     ----------------------------------------------------------------------                                                                         Label the cells 1-7 by clicking them sequentially, as shown in the top left figure, and label the region not belonging to the cells (1-7) as cell 8. In case there is a cell missing, you need to label the cells 1-6 first, and then, label the region not belonging to the cells (1-6) as cells 7 and 8 by clicking two times on the respective region.',...
                                        'BeeID', 'Got it!', 'e');
                                end
                                if firstTime == 0
                                    answer = 'Got it!';
                                ...
                                switch answer
                                    case 'Got it!'
                                        ...
                                        ButtonName = MFquestdlg ( [ 0.24 , 0.1 ], 'Do your labeled cells match the template shown on the left image?', ...
                                            'Bee-ID', ...
                                        ...
                                        switch ButtonName
                                            ...
                                            case 'Yes, proceed.'
                                                ...
                                                ButtonName = MFquestdlg ( [ 0.44 , 0.4 ], 'Add/Classify?', ...
                                                    'Bee-ID', ...
                                                    'Yes', 'No', 'Green');
                                                ...
                                                switch ButtonName                                                        
                                                    case 'Yes'
                                                        ...
                                                        ButtonName = MFquestdlg ( [ 0.22 , 0.405 ], 'Your labeled bee wing image was added to the database. Would you like to see the classification results?', ...
                                                            'Bee-ID', ...
                                                            'Yes', 'No', 'Green');
                                                        ...
                                                        switch ButtonName
                                                            case 'Yes'
                                                                ...
                                                                %pause(1);
                                                                %close all;
                                                                %, speciesClass, genderClass,subspeciesClass, lrwingClass
                                                                %keyboard
                                                                [genusClass, speciesClass, genderClass,subspeciesClass, lrwingClass] = ClassifyImage(limg2, zoom);
                                                                ButtonName = MFquestdlg ( [ 0.22 , 0.405 ], 'Your labeled bee wing image was added to the database. Would you like to see the classification results?', ...
                                                                    'Bee-ID', ...
                                                                    'Yes', 'No', 'Green');
                                                                
                                                                genus_1 = strcat('was classified as "',genusClass, '"');%, '" should be "', genus, '"'); 
                                                                species_1 = strcat('was classified as "',speciesClass,'"');%, '" should be "',species, '"');
                                                                subspecies_1 = strcat('classified as "',subspeciesClass, '" should be "',subspecies, '"');
                                                                gender_1 = strcat('classified as "',genderClass, '" should be "',gender, '"');
