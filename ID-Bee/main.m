...
load('trainingdata')% training data, includes scaling info (mu\s), feature indices
mu = nanmean(data);
s = nanstd(data);
...
%%%%%%%%%%%%%%%%%%%%%%
    ...
    % classify
    training = data(1:3:60);% or your choice of a few columns of data
    traininggroups = species; % or genus, or your choice of group
